...
static void BubbleBackward(My402List *pList, My402ListElem **pp_elem1, My402ListElem **pp_elem2)
...
static void CompareTestList(My402List *pList1, My402List *pList2, int num_items)
{
