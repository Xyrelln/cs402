...
do
  case $i in
    0)
      echo "===> test_0 (minimum emulation time is 26.531 seconds)"
      ...
      ;;
    1)
      echo "===> test_1 (minimum emulation time is 23.027 seconds)"
      echo -n "     start time: "; date +%d%b%Y-%H%M%S.%N
      ...
      ;;
    2)
      echo "===> test_2 (minimum emulation time is 13.114 seconds)"
      echo -n "     start time: "; date +%d%b%Y-%H%M%S.%N
      ...
      ;;
    3)
      echo "===> test_3 (minimum emulation time is 16.84765 seconds)"
      echo -n "     start time: "; date +%d%b%Y-%H%M%S.%N
      ...
      ;;
    4)
      echo "===> test_4 (minimum emulation time is 18.06 seconds)"
      echo -n "     start time: "; date +%d%b%Y-%H%M%S.%N
      ...
      ;;
    5)
      echo "===> test_5 (minimum emulation time is 20.384435 seconds)"
      echo -n "     start time: "; date +%d%b%Y-%H%M%S.%N
      ...
      ;;
    6)
      echo "===> test_6 (minimum emulation time is 14.169 seconds)"
      echo -n "     start time: "; date +%d%b%Y-%H%M%S.%N
      ...
      ;;
    7)
      echo "===> test_7 (minimum emulation time is 15.196 seconds)"
      echo -n "     start time: "; date +%d%b%Y-%H%M%S.%N
      ...
      ;;
    8)
      echo "===> test_8 (minimum emulation time is 15.33332 seconds)"
      echo -n "     start time: "; date +%d%b%Y-%H%M%S.%N
      ...
      ;;
    9)
      echo "===> test_9 (minimum emulation time is 13.429 seconds)"
      echo -n "     start time: "; date +%d%b%Y-%H%M%S.%N
